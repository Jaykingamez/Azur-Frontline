...
The base Azur room has a modified display header that shows a little mini-map.

All Azur rooms inherit from this room, and it is integral to combat as well as
the dungeon generation. But one can also mix with other non-Azur rooms (you will
...
class AzurRoom(DefaultRoom):
    """
    Simple room supporting some Azur-specifics.
